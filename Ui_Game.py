...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayoutInfo.setWidget(7, QtWidgets.QFormLayout.SpanningRole, self.labelGold)
        self.labelWeapon = QtWidgets.QLabel(self.formLayoutWidget)
        self.labelWeapon.setObjectName("labelWeapon")
        self.formLayoutInfo.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.labelWeapon)
        self.labelWEquippped = QtWidgets.QLabel(self.formLayoutWidget)
        self.labelWEquippped.setObjectName("labelWEquippped")
        self.formLayoutInfo.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.labelWEquippped)
        self.labelArmor = QtWidgets.QLabel(self.formLayoutWidget)
        self.labelArmor.setObjectName("labelArmor")
        self.formLayoutInfo.setWidget(9, QtWidgets.QFormLayout.LabelRole, self.labelArmor)
        self.labelAEquipped = QtWidgets.QLabel(self.formLayoutWidget)
        self.labelAEquipped.setObjectName("labelAEquipped")
        self.formLayoutInfo.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.labelAEquipped)
